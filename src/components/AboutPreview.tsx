        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <ScrollReveal variant="fadeLeft">
            <div className="relative">
              <div className="relative aspect-4/5 overflow-hidden rounded-[1.75rem]">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-[#0a0a0a]/12 via-transparent to-transparent" />
              </div>
              <div className="absolute -bottom-6 right-4 rounded-[1.25rem] border border-accent/20 bg-[#fffaf1] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.08)] md:-right-8">
                <span className="text-5xl font-light text-accent">{companyInfo.experience}</span>
                <p className="mt-1 font-sans text-xs uppercase tracking-[0.2em] text-[#0a0a0a]/45">
          ...
          <div className="relative z-10">
            <ScrollReveal variant="fadeRight">
              ...
              <h2 className="mt-4 text-4xl font-light leading-[1.2] tracking-tight text-[#0a0a0a] md:text-5xl">
            ...
            <ScrollReveal variant="fadeRight" delay={0.2}>
              <p className="mt-6 font-sans text-base leading-relaxed text-[#0a0a0a]/64">
              ...
              <p className="mt-4 font-sans text-base leading-relaxed text-[#0a0a0a]/64">
            ...
            <ScrollReveal variant="fadeRight" delay={0.3}>
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div key={item.label} className="rounded-[1.25rem] border border-black/8 bg-[#fafafa] p-5">
                    <h4 className="font-sans text-sm font-semibold text-[#0a0a0a]">
                      {item.label}
                    </h4>
                    <p className="mt-2 font-sans text-sm leading-relaxed text-[#0a0a0a]/52">{item.desc}</p>
                  </div>
                ))}
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal variant="fadeRight" delay={0.35}>
              <div className="mt-8 rounded-3xl border border-accent/20 bg-[#fffaf1] p-5">
                <p className="font-sans text-sm leading-relaxed text-[#0a0a0a]/72">
            ...
            <ScrollReveal variant="fadeRight" delay={0.4}>
              <Link
                href="/about"
                className="group mt-10 inline-flex items-center gap-3 font-sans text-sm font-medium uppercase tracking-wider text-accent transition-colors hover:text-[#0a0a0a]"
              >
                Learn More About Us
